...
namespace FlowerFarmTaskManagementSystem.API.Controllers
{
    public class FieldsController : Controller
    {
        ...
        public FieldsController(FlowerFarmTaskManagementSystemDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("FieldId,FieldName,Length,Width,Description,FieldImageUrl,CreateDate,UpdateDate,Status")] Field @field)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("FieldId,FieldName,Length,Width,Description,FieldImageUrl,CreateDate,UpdateDate,Status")] Field @field)
        {
            if (id != @field.FieldId)
            {
                return NotFound();
